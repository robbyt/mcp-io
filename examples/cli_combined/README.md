...
┌─────────────────┐                                ┌──────────────────┐
│   Workflow:     │                                │                  │
│   1. Get        │ ── resources/read ───────────> │  Template        │
│      template   │ ◄─ doc://templates/email ───── │  Resource        │
│                 │                                │                  │
│   2. Process    │ ── tools/call ───────────────> │  Text            │
│      content    │ ◄─ analyze_text(text) ──────── │  Tool            │
│                 │                                │                  │
│   3. Generate   │ ── prompts/get ──────────────> │  Content         │
│      with AI    │ ◄─ document_writer(args) ───── │  Prompt          │
└─────────────────┘                                └──────────────────┘
         │
         ▼
┌─────────────────┐
│ Complete        │ ──> "Using email template, analyzed 150 words,
│ LLM Response    │     generated professional email about quarterly results"
│ with All Data   │
└─────────────────┘
```
