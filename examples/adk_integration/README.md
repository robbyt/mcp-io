...
Available Gemini models include `gemini-2.0-flash-exp`, `gemini-2.5-flash`, `gemini-2.5-pro`.
...
4. **Gemini Model**: `gemini.NewModel()` initializes the Gemini LLM
5. **ADK Agent**: `llmagent.New()` creates an agent with the MCP toolset and Gemini model
